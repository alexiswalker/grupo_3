...
st.title(st.session_state.empresa)
...
fig.update_layout(title=f'Empresas de IT similares a {st.session_state.empresa}')
st.plotly_chart(fig)
...
fig.update_layout(title=f'Empresas de IT similares a {st.session_state.empresa}', xaxis_title="", yaxis_title="")
st.plotly_chart(fig)
