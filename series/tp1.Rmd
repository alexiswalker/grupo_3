...
```{r}
modelo <- arima(train_data, order = c(1,0,1))


colors <- c("train" = "blue", "test" = "red", "forecast" = "orange")
ggplot() +
  ...
  geom_line(data = as_tsibble(forecast(modelo, h = 7)$mean), aes(x = index, y = value, color = "forecast")) +
