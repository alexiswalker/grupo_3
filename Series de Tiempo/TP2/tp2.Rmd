...
En el trabajo practico anterior, se obtuvo un modelo $ARIMA(0,2,6)$ para modelar la serie IPC (ver summary en [Apendice](#ipc-modelo-arima)). Si bien la serie no parece presentar algún componente de estacionalidad, se propone un modelo $SARIMA(0,2,0)(0,2,6)[12]$ (ver summary en [Apendice](#ipc-modelo-sarima)) para compararlo con el modelo anterior.
...
El Indice de Precios al Consumidor y el Indice de Salarios no presentan un comportamiento estacional lo que evidencia una falta de políticas a largo plazo en cuanto a materia económica.

De no realizarse cambios en el rumbo económico, no se lograran mejorar los indicadores y el salario real seguirá decreciendo.
