...
La sugerencia de ajuste del Índice de Salarios por la búsqueda iterativa de la función `auto.arima {forecast}` de R, propone un modelo $AR(1)(1)_{12}$ lo que solo sugiere un intento cíclico de recomponer parcialmente la pérdida frente a la inflación.
