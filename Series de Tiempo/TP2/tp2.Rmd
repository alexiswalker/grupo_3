...
En esta prueba, la hipótesis nula determina que una serie temporal observable es estacionaria.
...
Conforme los resultados presentado en la Tabla \@ref(tab:kpss), se rechaza $H_{0}$.
