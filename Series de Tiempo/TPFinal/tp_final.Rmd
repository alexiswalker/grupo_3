...
```{r}
irf_base_monetaria <- irf(var_model, impulse = "dif_ts_base_monetaria_star", response = "dif_ts_indice_precios_consumidor",  n.ahead = 12)

irf_ipc <- irf(var_model, impulse = "dif_ts_indice_precios_consumidor", response = "dif_ts_base_monetaria_star",  n.ahead = 12)
```
