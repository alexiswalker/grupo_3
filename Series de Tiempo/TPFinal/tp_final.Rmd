...
```{r}
holidays <- read.csv('elecciones.csv')
```
...
En la Tabla \@ref(tab:ipc-prophet-acc) se detallan las métricas de testing obtenidas al entrenar el modelo Prophet para la serie IPC. 
