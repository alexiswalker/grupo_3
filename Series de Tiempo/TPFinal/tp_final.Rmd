...
#accuracy(tail(original_test_ipc, n=length(test_ipc)), tail(diff_inv(ipc_bm_model_forecast$forecast$train_ipc$mean, original_test_ipc, ipc_ndiffs), n=length(test_ipc)))
ipc_var_accuracy <- accuracy(tail(original_test_ipc, n=length(test_ipc)), tail(diff_inv(ipc_is_model_forecast$forecast$train_ipc$mean, original_test_ipc, ipc_ndiffs), n=length(test_ipc)))

is_var_accuracy <- accuracy(tail(original_test_is, n=length(test_is)), tail(diff_inv(ipc_is_model_forecast$forecast$train_is$mean, original_test_is, is_ndiffs), n=length(test_is)))
...
bm_var_accuracy <- accuracy(tail(original_test_bm, n=length(test_bm)), tail(diff_inv(is_bm_model_forecast$forecast$train_bm$mean, original_test_bm, bm_ndiffs), n=length(test_bm)))
```
