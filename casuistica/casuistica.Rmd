...
Con el ya instituido entendimiento en distintos estratos y roles dentro de las compañías sobre la necesidad de trabajar con dato, y su carácter de activo que conlleva a reconocer el valor estratégico de su explotación; es importante ocuparse del ciclo de vida de los mismos. Este concepto se identifica en la industria como: *DataOps* y *MLOps*.
...
Hoy, las soluciones originadas a partir de los datos, se tornaron críticas; esto debido al estar cada vez más embebidas en los sistemas *cores* de una empresa. Por otro lado, la evidencia concreta del valor que son capaces de otorgar, ha significado una importante alfabetización de las áreas usuarias, implicando una mayor y más compleja demanda. Lo que se traduce en la exposición de aquello profesionales encargados de desarrollarlas.

Los problemas comunes que surgen en este contexto suelen ser: el constante flujo de nuevas necesidades producto de los casos de éxito, la baja calidad de los datos y la naturaleza cambiante del producto entregado (siempre existe algo para mejorar).
...
Al panorama descrito se suma una baja credibilidad en las chance de éxito que este tipo de proyecto tiene, sustentada por estudios realizados por las principales consultoras globales.

La realidad detallada, es el *driver*, la argumentación, que traccionó la necesidad de implementar nuevas herramientas para aumentar y mejorar el procesamiento. 
